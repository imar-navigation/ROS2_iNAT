...
class Odometry : public XComMessages_Odo, xcom::ResponseHandler //  , XComParameters_Imu, xcom::CommandHandler
{
public:
    Odometry(rclcpp_lifecycle::LifecycleNode::SharedPtr node,
...
//    rclcpp_lifecycle::LifecyclePublisher<ImuMsg>::SharedPtr pub_;
    rclcpp::Publisher<OdometryMsg>::SharedPtr pub_;
