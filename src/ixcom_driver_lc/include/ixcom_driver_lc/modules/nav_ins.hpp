...
using XComMessages_NavIns = xcom::MessageHandler<XCOMmsg_GNSSSOL, XCOMmsg_INSSOL>;
using XComParameters_NavIns = xcom::ParameterHandler<XCOMParGNSS_LOCKOUTSYSTEM, XCOMParDAT_POS>;
...
private:
    ...
    std::atomic_uint32_t par_POS_age_ = 0;
