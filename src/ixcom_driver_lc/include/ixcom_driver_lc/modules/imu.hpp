...
class IMU : public XComMessages_Imu, XComParameters_Imu, xcom::ResponseHandler //, xcom::CommandHandler
{
public:
    IMU(rclcpp_lifecycle::LifecycleNode::SharedPtr node,
...
//    rclcpp_lifecycle::LifecyclePublisher<ImuMsg>::SharedPtr pub_;
    ...
    // std::chrono::time_point<std::chrono::high_resolution_clock> t_inssol_;
    // std::chrono::time_point<std::chrono::high_resolution_clock> t_inssol_upd_;
    // std::chrono::time_point<std::chrono::high_resolution_clock> t_imucorr_;
    // std::chrono::time_point<std::chrono::high_resolution_clock> t_imucorr_upd_;
