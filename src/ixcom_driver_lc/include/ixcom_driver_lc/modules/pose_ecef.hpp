...
using XComMessages_PoseCovStamped = xcom::MessageHandler<
                                    XCOMmsg_INSSOLECEF,
                                    XCOMmsg_EKFSTDDEVECEF>;

class PoseWithCovarianceStamped : public XComMessages_PoseCovStamped, xcom::ResponseHandler //  , XComParameters_Imu, xcom::CommandHandler
{
public:
    PoseWithCovarianceStamped(rclcpp_lifecycle::LifecycleNode::SharedPtr node,
...
private:
    ...
    void updateEKFSTDDEVECEF(const XCOMmsg_EKFSTDDEVECEF &msg);
    void publish();
