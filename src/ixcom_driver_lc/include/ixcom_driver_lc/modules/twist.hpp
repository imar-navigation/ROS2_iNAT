...
class TwistStamped : public XComMessages_Twist, xcom::ResponseHandler //  , XComParameters_Imu, xcom::CommandHandler
{
public:
    TwistStamped(rclcpp_lifecycle::LifecycleNode::SharedPtr node,
...
private:
    ...
    void updateINSDCM(const XCOMmsg_INSDCM &msg);
    ...
    rclcpp::Publisher<TwistStampedMsg>::SharedPtr pub_;
    ...
    uint16_t msg_INSDCM_frq_ = 0;
    std::atomic_uint32_t msg_INSDCM_age_ = ATOMIC_VAR_INIT(0);
    uint32_t msg_INSDCM_c_ = 0;
