...
using XComMessages_NavSatStatus = xcom::MessageHandler<XCOMmsg_GNSSSOL>;
using XComParameters_NavSatStatus = xcom::ParameterHandler<XCOMParGNSS_LOCKOUTSYSTEM>;

class NavSatStatus : public XComMessages_NavSatStatus, XComParameters_NavSatStatus, xcom::ResponseHandler //, xcom::CommandHandler
{
public:
    NavSatStatus(rclcpp_lifecycle::LifecycleNode::SharedPtr node,
...
//    rclcpp_lifecycle::LifecyclePublisher<ImuMsg>::SharedPtr pub_;
    rclcpp::Publisher<NavSatStatusMsg>::SharedPtr pub_;
    ...
    std::atomic_uint32_t par_LOCKOUTSYSTEM_age_ = 0;
